...
def get_today_withdrawal_total(account_number):
    ...
    for transaction in transactions:
        if (
            transaction.get("account_number") == account_number
            and
            transaction.get("transaction") == "Withdraw"
            and
            transaction.get("timestamp", "").startswith(today)
        ):
